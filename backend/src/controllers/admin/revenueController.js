...
const getRevenueOverviewController = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new SuccessResponse("Lấy tổng quan doanh thu thành công", result));
});
...
const getRevenueByBranchController = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new SuccessResponse("Lấy doanh thu theo chi nhánh thành công", result),
    );
});
...
const getRevenueByDateController = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new SuccessResponse("Lấy doanh thu theo ngày thành công", result));
});
...
const getRevenueByMonthController = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new SuccessResponse("Lấy doanh thu theo tháng thành công", result));
});
...
const getRevenueByBranchDetailController = asyncHandler(async (req, res) => {
  ...
  return res
    ...
    .json(
      new SuccessResponse(
        "Lấy chi tiết doanh thu chi nhánh thành công",
        result,
      ),
    );
});
...
const getRevenueProductsController = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new SuccessResponse("Lấy doanh thu sản phẩm thành công", result));
});
...
const getRevenueBeveragesController = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new SuccessResponse("Lấy doanh thu đồ uống thành công", result));
});
...
const getDashboardController = asyncHandler(async (req, res) => {
  ...
  return res
    ...
    .json(
      new SuccessResponse(
        "Lấy dữ liệu tổng quan bảng điều khiển thành công",
        result,
      ),
    );
});
...
const getRevenueReportController = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new SuccessResponse("Lấy báo cáo doanh thu thành công", result));
});
