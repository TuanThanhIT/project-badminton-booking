...
import { requestCancelOrder } from "../../../../redux/slices/user/orderSlice";
import type { RequestCancelOrderRequest } from "../../../../types/order";
...
const CancelOrderModal = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      setIsLoading(true);
      const data: RequestCancelOrderRequest = { reason: reason.trim() };
