    ...
    dispatch(login({ data }))
      ...
      .then((res) => {
        ...
        if (user?.role !== ROLE_NAME.MANAGER) {
          toast.error("Tài khoản không phải quản lý");
    ...
    >
      ...
      >
        ...
        <div className="relative hidden lg:block h-[460px]">
          <img src="/img/manager.webp" className="w-full h-full object-cover" />
          ...
          >
            ...
            >
              B-Hub
              <span className="block text-cyan-300">Manager System</span>
            </h2>

            <p className="mt-3 text-sm leading-relaxed text-white/80 max-w-md">
              Đăng nhập để quản lý vận hành cửa hàng, sản phẩm và đơn hàng.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-slate-500 leading-relaxed">
              Khu vực dành cho quản lý hệ thống.
            </p>
          </div>
