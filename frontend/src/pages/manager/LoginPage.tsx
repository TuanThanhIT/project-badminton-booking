...
const LoginPage = () => {
  ...
  const loginLoading = useAppSelector(
    (state) => state.ui.loadingMap["auth/managerLogin"] || false,
  );
          ...
          <div className="relative hidden h-[min(510px,calc(100vh-180px))] overflow-hidden lg:block">
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 text-white">
              ...
              <p className="mt-3 max-w-lg text-sm leading-relaxed text-sky-100">
                Đăng nhập để theo dõi vận hành, xử lý hoạt động cửa hàng và quản
                lý quy trình làm việc.
              </p>
            </div>
          </div>
            ...
            >
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Khu vực dành cho quản lý vận hành B-Hub.
                </p>
              </div>
