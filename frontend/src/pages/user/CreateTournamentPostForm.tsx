    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        ...
        {errors.formData?.organizerName && (
          <p className="text-red-500 text-sm mt-1">{errors.formData.organizerName.message}</p>
        )}
      </div>
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mb-2">Tích chọn các hạng mục tổ chức (có thể chọn nhiều).</p>
        ...
        {errors.formData?.categories && (
          <p className="text-red-500 text-sm mt-1">{errors.formData.categories.message}</p>
        )}
      </div>
